...
const posts = [
    {
        title: 'მილოცვა კურსდამთავრებულებს ',
        text: 'თბილისის N142 საჯარო სკოლის დირექტორი კურსდამთავრებულებს სასურველ უნივერსიტეტებში ჩარიცხვას ულოცავს <a href="https://www.etaloni.ge/geo/main/index/126000" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline;">etaloni.ge</a>',
        images: [
            'images/mainpostsimages/მილოცვაკურსდამთავრებულებს/1.jpg'
        ]
    },
    {
        title: '',
        text: '142-я ❤️ #НашаШкола Дорогие учителя, ученики, родители и вся большая школьная семья! От всей души и с огромной гордостью поздравляю вас с этой важнейшей победой — наша школа получила авторизацию сроком на 9 лет! Это не просто официальный статус. Это признание большого труда, профессионализма и самоотдачи, которые каждый учитель и член администрации ежедневно вкладывает в будущее нашей страны. Это подтверждение того, что наша школа — это пространство, где качество образования, развитие и забота являются главными ценностями. Спасибо нашим педагогам за профессиональную преданность и самоотверженный труд, ученикам — за академические достижения и целеустремлённость, родителям — за доверие и поддержку. Эти 9 лет признания — лишь начало пути к новым вершинам. Верю, что впереди нас ждёт ещё множество общих успехов, достижений и счастливых моментов! Поздравляю всех и желаю новых побед! ❤️👏💐',
        images: [
            'images/mainpostsimages/ავტორიზაცია9წელი/1.jpg',
        ]
    },
    {
        title: '',
        text: '142- ე❤️ #ჩვენისკოლა ძვირფასო მასწავლებლებო, მოსწავლეებო, მშობლებო და სკოლის დიდო ოჯახო! გულწრფელად და უდიდესი სიამაყით გილოცავთ ამ უმნიშვნელოვანეს გამარჯვებას — ჩვენმა სკოლამ 9-წლიანი ავტორიზაცია მოიპოვა! ეს არ არის უბრალოდ ოფიციალური სტატუსი. ეს არის იმ დიდი ამაგის, პროფესიონალიზმისა და დაუღალავი შრომის აღიარება, რასაც თითოეული მასწავლებელი და ადმინისტრაციის წევრი ყოველდღიურად დებს ჩვენი ქვეყნის მომავალში. ეს არის დასტური იმისა, რომ ჩვენი სკოლა არის სივრცე, სადაც ხარისხი, განვითარება და ზრუნვა მთავარი ღირებულებებია. მადლობა ჩვენს პედაგოგებს პროფესიული ერთგულებისთვის, მოსწავლეებს — აკადემიური მიღწევებისა და მიზანდასახულობისთვის, მადლობა მშობლებს — ნდობისა და მხარდაჭერისთვის. ეს 9-წლიანი აღიარება ახალი მწვერვალებისკენ სვლის საწყისია.  მჯერა, წინ კიდევ უამრავი საერთო წარმატება და სიხარული გველოდება! გილოცავთ და გისურვებთ ახალ-ახალ გამარჯვებებს!',
        images: [
            'images/mainpostsimages/ავტორიზაცია9წელი/1.mp4',
        ]
    },
    {
